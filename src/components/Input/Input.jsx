const Input = (props) => {
  return (
    <input
      ...
      focus: border-2 focus:border-alura-200 focus:dark:border-alura-100 invalid:focus:border-2 focus:invalid:border-red-400
      invalid:dark:border-2 focus:invalid:dark:border-red-400"
      {...props}
    ></input>
  );
};
